const cardData = [
    ...
    {
        title: "Quiz",
        description: "Take quizzes with real-time AI feedback and performance analysis.",
        iconSrc: "quiz.png",
        iconAlt: "Quiz Icon"
    },
    {
    ...
    {
        title: "Course",
        description: "Explore courses designed to help you excel with AI-powered guidance.",
        iconSrc: "Course.png",
        iconAlt: "Course Icon"
    }
];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 px-4 sm:px-8">
                {cardData.map((card, index) => (
                    ...
                    >
                        ...
                        <h2 className="text-xl font-semibold text-center text-gray-900">{card.title}</h2>
