    ...
    return (
        <div className="font-inter">
            ...
            <section id="features" className="px-6 bg-[#f4f4f4] py-10">
                <div>
                    <h1 className="text-base lg:text-lg font-semibold uppercase mb-2 text-[#27569E] tracking-wider text-center">
                        __Our Features
                    </h1>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6 max-w-7xl mx-auto">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className="w-full h-48 bg-white shadow-xl hover:bg-blue-50 border border-[#27569E]  flex flex-col items-center text-center transition-all ease-in-out duration-500 hover:shadow-2xl transform hover:scale-105 p-6"
                            >
                                {/* Icon in Card */}
                ...
                <div className="flex flex-col md:flex-row items-center justify-between px-6 lg:px-24">
                    ...
                    <div className="w-full lg:w-1/2 md:px-6 lg:px-16 space-y-6">
                        <form className="space-y-4">
                            <div>
                                <label htmlFor="name" className="block text-sm font-semibold text-[#27569E] mb-1">
                                    Full Name
                                </label>
                                <input
                                    type="text"
                                    ...
                                    className="w-full px-4 py-3 border border-gray-300 shadow-sm focus:outline-none focus:ring-1 focus:ring-[#27569E] transition-all text-gray-800"
                                />
                            </div>

                            <div>
                                <label htmlFor="email" className="block text-sm font-semibold text-[#27569E] mb-1">
                                    E-mail
                                </label>
                                <input
                                    type="email"
                            ...
                            <div>
                                <label htmlFor="message" className="block text-sm font-semibold text-[#27569E] mb-1">
                                    Message
                                </label>
                                <textarea
                                    id="message"
                            ...
                            <button
                                type="submit"
                                className="relative px-10 py-3 bg-gradient-to-tr from-[#27569E] to-[#4A90E2]  text-white font-semibold text-lg rounded-full overflow-hidden shadow-md transition-all hover:shadow-lg group"
                            >
                                Submit
                            </button>
                        </form>
