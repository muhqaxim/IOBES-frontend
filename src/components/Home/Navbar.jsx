                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="hidden md:flex space-x-8 items-center">
                        ...
                        <div className="ml-6 space-x-4">
                            <Link to="/login">
                                <button className="relative px-6 py-2 border-2 border-[#27569E] text-[#27569E] font-semibold rounded-lg overflow-hidden ease-in-out transition duration-500 group">
                                    <span className="absolute inset-0 bg-[#27569E] scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-in-out origin-center"></span>
                            ...
                            <Link to="/register">
                                <button className="relative px-6 py-2 text-white bg-[#27569E] border-2 border-[#27569E] font-semibold rounded-lg ease-in-out overflow-hidden transition duration-500 group">
                                    ...
                                    <span className="relative z-10 group-hover:text-[#27569E]">
                                        Register
                                    </span>
                                </button>
                            </Link>
                    ...
                    >
                        <div className="flex flex-col text-center space-y-4 py-6">
                            ...
                            <div className="px-6 space-y-3">
                                <Link to="/login">
                                    <button className="block w-full px-6 py-2 mb-2 bg-white border border-[#27569E] text-[#27569E] font-semibold shadow-md  transition  rounded-lg">
                                        Login
                                    </button>
                                </Link>
                                <Link to="/register">
                                    <button className="block w-full px-6 py-2 bg-[#27569E] text-white font-semibold shadow-md  transition duration-300 rounded-lg">
                                        Register
                                    </button>
                                </Link>
                            </div>
