...
//             {/* Hero Section */}
//             <div className="relative pt-20 lg:pt-16 xl:pt-12 max-h-screen bg-[#27569E] border-b border-black">
//                 {/* Carousel */}
...
const HeroAboutSection = () => {
    ...
    return (
        <section className="font-inter">
            {/* Hero Section */}
            <div className="relative pt-20 lg:pt-16 xl:pt-12 max-h-screen bg-gradient-to-tr from-[#27569E] to-[#4A90E2] border-b border-black">
                {/* Carousel */}
                <div className="h-full overflow-hidden">
                    <div
                        className="flex transition-transform duration-1000 ease-in-out"
            ...
            <div className=" bg-gray-50 text-black flex flex-col md:flex-row items-center text-center md:text-left">
                <div className="container mx-auto px-6 md:px-16 flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:w-1/2 mt-8 md:mt-0 space-y-4">
                        ...
                        <Link to="/about">
                            <button
                                className="relative w-48 h-14 mt-4 bg-gradient-to-r from-[#27569E] to-[#3682e0]  text-white font-semibold text-lg rounded-full shadow-lg transition-all duration-500 ease-in-out transform hover:scale-105 hover:shadow-xl"
                            >
                                Get In Touch
                            </button>
                        </Link>
